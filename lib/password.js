...
var tests = [testPasswordMinLength, testPasswordMaxLength, testRepeatingCharacters, testLowercaseLetter, testUppercaseLetter, testNumber, testSpecialCharacter];
...
function testPassword(password) {
  ...
  tests.forEach(function (test) {
    var testResult = test(password, mergedConfig);
